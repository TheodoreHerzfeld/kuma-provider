...
import (
	"context"
	"fmt"
	"github.com/TheodoreHerzfeld/terraform-provider-uptime-kuma/internal/sdk/internal/hooks"
	"github.com/TheodoreHerzfeld/terraform-provider-uptime-kuma/internal/sdk/internal/utils"
	"github.com/TheodoreHerzfeld/terraform-provider-uptime-kuma/internal/sdk/models/shared"
	"github.com/TheodoreHerzfeld/terraform-provider-uptime-kuma/internal/sdk/retry"
	"net/http"
	"time"
)
...
type SDKOption func(*UptimeKuma)

// WithServerURL allows the overriding of the default server URL
func WithServerURL(serverURL string) SDKOption {
	return func(sdk *UptimeKuma) {
...
func New(opts ...SDKOption) *UptimeKuma {
	sdk := &UptimeKuma{
		sdkConfiguration: sdkConfiguration{
			Language:          "go",
			...
			SDKVersion:        "0.0.1",
			GenVersion:        "2.460.1",
			UserAgent:         "speakeasy-sdk/go 0.0.1 2.460.1 0.1.0 github.com/TheodoreHerzfeld/terraform-provider-uptime-kuma/internal/sdk",
			Hooks:             hooks.New(),
		},
	}
